...
# Importaciones de los módulos de ML
...
# Importar componentes para las rutas de modelos
from python.sem7.routes_modelos_db import modelos_bp
...
# Inicialización de modelos de ML
